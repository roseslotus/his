...
public class SalesFragment extends BaseFragment implements View.OnClickListener, OnRefreshListener, OnLoadMoreListener {
    ...
    private void initAdapter2() {
        ...
        commonAdapter1 = new CommonAdapter<ReceptionTypeEntity>(getActivity(), R.layout.item_filtrate_product_list, receptionTypeEntitieList) {
            @Override
            protected void convert(final ViewHolder viewHolder, final ReceptionTypeEntity item, int position) {
                ...
                tagAdapter = new TagAdapter(item.getList()) {
                    ...
                    public View getView(FlowLayout parent, int position, Object o) {
                        TextView textView = (TextView) LayoutInflater.from(getActivity()).inflate(R.layout.item_text_label, null);
    ...
    private void initTimeView1() {
        TimePV1 = new TimePickerBuilder(getActivity(), new OnTimeSelectListener() {
            @Override
    ...
    private void initTimeView2() {
        TimePV2 = new TimePickerBuilder(getActivity(), new OnTimeSelectListener() {
            @Override
            public void onTimeSelect(Date date, View v) {
    ...
    private void getIntentionData() {
        HttpClient.getHttpApi().getIntentionAll().enqueue(new BaseBack<List<IntentionEntity>>() {
            ...
            protected void onSuccess(List<IntentionEntity> intentionEntities) {
                IntentionPV1 = viewUtil1.initIntention(getActivity(), IntentionPV1, intentionEntities);
                IntentionPV2 = viewUtil2.initIntention(getActivity(), IntentionPV2, intentionEntities);
            }
    ...
    @OnClick({R.id.search_btn, R.id.filtrate_btn, R.id.reset_btn, R.id.confirm_btn, R.id.start_time_btn, R.id.end_time_btn, R.id.yx_text, R.id.cp_text, R.id.clear_text1, R.id.clear_text2, R.id.clear_text3})
    @Override
    public void onClick(View v) {
        switch (v.getId()) {
