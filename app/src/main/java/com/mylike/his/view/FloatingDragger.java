...
public class FloatingDragger implements Observer {
    ...
    public FloatingDragger(Context context, @LayoutRes int layoutResID) {
        ...
        floatingDraggedView.addView(floatingView, new FrameLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
//        floatingDraggedView.addView(floatingView, new FrameLayout.LayoutParams(dip2px(context, 50), dip2px(context, 50)));
    ...
    public class FloatingDraggedView extends FrameLayout {
        ...
        public void showMenuDialog() {
            ...
            builder.setTitle("提示");
            builder.setMessage("是否确认置空闲？");
            builder.setPositiveButton("确认", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    floatingBtn.setImageResource(R.mipmap.free_icon);
