...
/**
 * Created by zhengluping on 2018/4/2.
 */
...
public class CheckRecordDetailsActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        checkRecordDetailsList.setAdapter(new CommonAdapter<String>(this, R.layout.item_check_record_details_list, DataUtil.getData(6)) {
            @Override
