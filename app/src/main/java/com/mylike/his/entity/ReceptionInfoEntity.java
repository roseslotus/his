...
public class ReceptionInfoEntity {
    ...
    private String FENZHENZHUANGTAI;
    private String FID;
    ...
    public void setCanBillingFlag(String canBillingFlag) {
        this.canBillingFlag = canBillingFlag;
    }
    ...
    public String getFENZHENZHUANGTAI() {
        return FENZHENZHUANGTAI;
    }

    public void setFENZHENZHUANGTAI(String FENZHENZHUANGTAI) {
        this.FENZHENZHUANGTAI = FENZHENZHUANGTAI;
    }
